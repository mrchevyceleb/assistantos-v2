...
import { Save, X, FileText, Bold, Italic, List, ListOrdered, Code, Heading1, Heading2, Heading3, Quote, Link } from 'lucide-react'
import { useAppStore } from '../../stores/appStore'
import { Editor, rootCtx, defaultValueCtx, editorViewOptionsCtx } from '@milkdown/kit/core'
import { commonmark, toggleStrongCommand, toggleEmphasisCommand, wrapInBulletListCommand, wrapInOrderedListCommand, wrapInBlockquoteCommand, insertHrCommand } from '@milkdown/kit/preset/commonmark'
